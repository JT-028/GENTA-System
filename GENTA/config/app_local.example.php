...
return [
    ...
    /*
     * Flask / IoT report API (GENTA_Flask.py).
     * Leave apiKey empty in git; set NGROK_API_KEY in the environment.
     */
    'Ngrok' => [
        'baseUrl' => env('NGROK_BASE_URL', 'http://localhost:5000'),
        'apiKey' => env('NGROK_API_KEY', ''),
